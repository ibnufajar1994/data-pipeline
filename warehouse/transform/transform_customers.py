...
def transform_customers(data: pd.DataFrame, table_name: str) -> pd.DataFrame:
    """
    This function is used to transform customers from staging database to be loaded on dim_customers table on data warehouse.
    """
    try:
        ...
        # deduplication based on nk_customer_id
