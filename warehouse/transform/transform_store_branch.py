...
def transform_store_branch(data: pd.DataFrame, table_name: str) -> pd.DataFrame:
    """
    This function is used to transform store_branch from staging database to be loaded on dim_store_branch table on data warehouse.
    """
    try:
        ...
        # deduplication based on nk_store_id
